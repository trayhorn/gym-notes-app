...
export default function AddWorkoutPage() {
  ...
  const [training, setTraining] = useState<ExerciseSet[]>(() => {
  ...
  const handleAddSuperset = (exercise: ExerciseSet, supersetId: string) => {
    setTraining(prev =>
      prev.map(el =>
        el.name === exercise.name ? { ...el, supersetGroup: supersetId } : el
      )
    );
  };
